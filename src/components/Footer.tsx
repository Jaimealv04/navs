    ...
    <footer id="contact" className="bg-black text-white border-t border-white/5">
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-light mb-6 tracking-wider">EGO HOUSE</h3>
            ...
            >
              <Instagram size={18} />
              <span className="text-sm">@egohouse</span>
            </motion.a>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-white/60">
              <div className="flex items-center gap-3">
                <Clock size={16} />
                <div>
                  <p>Lun-Vie: 18:00 - 02:00</p>
                  <p>Sáb-Dom: 16:00 - 03:00</p>
                </div>
              </div>
            </div>
          </div>
